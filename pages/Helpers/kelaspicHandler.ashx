<%@ WebHandler Language="VB" Class="kelaspicHandler" %>
...
Public Class kelaspicHandler : Implements IHttpHandler
    ...
    Private Function GenerateThumbnail(ByVal img As Image) As Byte()
        ...
        Try
            ...
            Try
                If InStr(HttpContext.Current.Request.UrlReferrer.ToString, "ibw.news") > 0 Then
