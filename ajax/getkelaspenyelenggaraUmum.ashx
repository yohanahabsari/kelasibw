<%@ WebHandler Language="VB" Class="getkelaspenyelenggaraUmum" %>

Imports System
Imports System.Web
Imports System.Data

Public Class getkelaspenyelenggaraUmum : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If s.CurEmail <> "" Then
            ds = o.ambilData("select nama from kelaspenyelenggara  group by nama order by nama")
        Else
